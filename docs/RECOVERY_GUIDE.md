...
This page is the reference version. The steps below preserve your work.
...
1. If you committed something you want to keep: create a branch here first.
2. Switch back to a normal branch.

## Diverged branch (ahead AND behind)

Your branch and its upstream each have commits the other lacks. Lamfa does
not merge or rebase this automatically.
